...
class ValidCodeImg:
    def __init__(self,width=150,height=30,code_count=5,font_size=32,point_count=20,line_count=5,img_format='png'):
        '''
    ...
    def getValidCodeImg(self):
        ...
        f = open('varifyCode.png','wb')
        image.save(f, self.img_format)
        f.close()
        return valid_str

def get_varify_image():
    img = ValidCodeImg()
